...
<div style="width:100%;background-color:#E0EFF7;">
    <div class="container">
        ...
        <div class="span-13 last" style="height:480px;">
            ...
            <div class="vfrm">
                <h6 style="color:red;"><?php echo $session->flash(); ?></h6>
                <?php echo $form->create('Vendor', array('action' => 'vadd')); ?>
                <?php echo $form->input('first_name', array( 'placeholder' => 'FIRST NAME','label'=>'')); ?>
                <?php echo $form->input('last_name', array( 'placeholder' => 'LAST NAME','label'=>'')); ?>
                <?php echo $form->input('email', array( 'placeholder' => 'EMAIL','label'=>'')); ?>
                <?php echo $form->input('phone', array( 'placeholder' => 'TELEPHONE','label'=>'')); ?>
                <?php echo $form->input('industry', array( 'placeholder' => 'INDUSTRY','label'=>'')); ?>
		<?php echo $form->checkbox('agree', array('label'=>'','style'=>'width:20px;')); ?>I agree to the <a class="oterms">Terms of Use</a>
                <br/><br/>
