...
$(document).ready(function() {
  $("#prt").click(function() {
    var ff = '<div id="party"><p>Sign up for our launch party on January 28th.</p><br/><?php echo $form->create('Vendor', array('action' => 'party'));
    ...
    echo $form->input('businessname', array( 'label' => 'Business Name: '));
    echo $form->input('businessurl', array( 'label' => 'Business URL: '));
    echo $form->input('guests', array( 'label' => 'Number of Guests: ')).'<br/>';
    echo $form->end(array('label'=>'Submit','class'=>'g')); ?><br/></div>';
